...
tput setaf $p
docker run -v /var/log/server:/var/log/server -v /usr/local/cert/.well-known:/static/.well-known -v /etc/letsencrypt:/etc/letsencrypt -p 80:80 -p 443:443 --name uptown_unicorn --restart always -d shawnblakesley/server
tput sgr0
